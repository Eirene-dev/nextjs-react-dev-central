...
date: '2023-04-03'
summary: 이 글은 React 애플리케이션에서 컴포넌트를 가져오고 내보내는 방법을 설명하고, 기본 내보내기와 명명된 내보내기를 사용하여 컴포넌트를 다루는 방법을 안내합니다.
---
...
<details className="bg-gray-100 p-2 rounded-md">
  <summary>자세히 알아보기: **기본 내보내기 vs 명명된 내보내기**</summary>
...
<details className="bg-gray-100 p-2 rounded-md">
  <summary>자세히 알아보기: **도전 과제: 컴포넌트를 더 세분화하기**</summary>
