...
```tsx:"app/dashboard/error.tsx" switcher
...
```jsx:"app/dashboard/error.js" switcher
'use client' // 오류 컴포넌트는 클라이언트 컴포넌트이어야 합니다.
...
[특별한 파일](/docs/nextjs/routing#파일-규칙)을 통해 생성된 React 컴포넌트들은 [특정 중첩 계층](/docs/nextjs/routing#컴포넌트-계층-구조)에서 렌더링됩니다.
...
```tsx:"app/global-error.tsx" switcher
'use client'
...
<details>
    <summary>JavaScript</summary>
```jsx:"app/global-error.js" switcher
'use client'
