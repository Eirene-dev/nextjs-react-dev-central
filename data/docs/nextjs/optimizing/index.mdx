...
게다가, [ImageResponse](https://nextjs.org/docs/app/api-reference/functions/image-response) 생성자를 사용하여 JSX와 CSS로 동적 Open Graph 이미지를 만들 수 있습니다.
...
대규모 어플리케이션의 경우, Next.js는 어플리케이션이 어떻게 수행되고 있는지 이해하는 데 도움을 주는 인기 있는 분석 및 모니터링 도구와 통합됩니다. [OpenTelemetry](/docs/nextjs//optimizing/open-telemetry) 및 [Instrumentation](/docs/nextjs/optimizing/instrumentation) 가이드에서 더 자세한 정보를 확인할 수 있습니다.
