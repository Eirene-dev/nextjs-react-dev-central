...
기본적으로, 서버 컴포넌트는 자동으로 [코드 분할](https://developer.mozilla.org/docs/Glossary/Code_splitting)되며, 서버에서 클라이언트로 UI의 일부를 점진적으로 보내기 위해 [스트리밍](/docs/app/building-your-application/routing/loading-ui-and-streaming)을 사용할 수 있습니다. 지연 로딩은 클라이언트 컴포넌트에 적용됩니다.
