...
```tsx:"app/other/page.tsx" switcher
'use client'
...
```jsx:"app/other/page.js" switcher
'use client'
...
```ts:"app/data.json/route.ts" switcher
...
<details>
    <summary>JavaScript</summary>
```js:"app/data.json/route.js" switcher
import { NextResponse } from 'next/server'
