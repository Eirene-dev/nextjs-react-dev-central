...
서버 컴포넌트를 스타일링하려면 [CSS 모듈](/docs/app/building-your-application/styling/css-modules) 또는 PostCSS나 [Tailwind CSS](/docs/app/building-your-application/styling/tailwind-css)와 같은 CSS 파일을 출력하는 다른 솔루션을 사용하는 것이 좋습니다.
...
그런 다음, 레지스트리로 [루트 레이아웃](/docs/app/building-your-application/routing/pages-and-layouts#root-layout-required)을 감싸십시오:
