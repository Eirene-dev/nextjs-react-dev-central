...
// Next 16 Turbopack 은 matcher 를 정적으로 분석 가능한 리터럴로만 허용한다(동적 .map 불가).
// 아래 배열은 위 `redirects` 의 키와 1:1 동기화 유지할 것.
export const config = {
    matcher: [
        '/levelup',
        '/blog/eslint-with-prettier',
        '/blog/selecting-ide-for-nextjs',
        '/blog/hot-code-reloading-and-fast-refresh',
        '/blog/10-web-apis',
        '/blog/arrow-and-regular-functions-in-javascript',
        '/blog/garbage-collection-in-javascript',
        '/blog/tree-shaking',
        '/blog/code-structure-and-maintenance-strategies-for-nextjs',
        '/blog/environment-variables-in-nextjs',
        '/blog/performance-nextjs-script-optimization',
        '/blog/performance-optimization-using-nextjs',
        '/blog/project-organization',
        '/blog/route-group',
        '/blog/understanding-isr-in-nextjs',
        '/blog/8-things-you-shold-konw-about-nextjs-13',
        '/blog/comparing-nextjs-nuxt-sveltekit',
        '/blog/nextjs-challenges',
        '/blog/nextjs-evolution',
        '/blog/nextjs-success-story',
        '/blog/what-is-nextjs',
        '/blog/conditional-rendering',
        '/blog/functional-component-with-typescript',
        '/blog/functional-programming',
        '/blog/goodbye-create-react-app',
        '/blog/hook-in-functional-component',
        '/blog/interaction-with-ui',
        '/blog/memo-callback-hook',
        '/blog/ref-hook',
        '/blog/state-context-reducer',
        '/blog/responsive-desing-in-nextjs',
        '/blog/styling-in-nextjs',
        '/blog/web-layouts',
        '/blog/developer-experience-in-web',
        '/blog/frontend-web-developer-roadmap',
        '/blog/good-website-design',
        '/blog/user-experience-in-web',
        '/blog/web-address-understanding',
        '/blog/web-rendering-understanding',
    ],
}
