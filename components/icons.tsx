...
export const Icons = {
  ...
  leftOpen: ({ ...props }: LucideProps) => (
    <svg
      ...
      className="block align-middle lucide lucide-panel-left-open"
    >
  ...
  leftClose: ({ ...props }: LucideProps) => (
    <svg
      ...
      stroke-linecap="round"
      stroke-linejoin="round"
      className="block align-middle lucide lucide-panel-left-close"
    >
      <rect width="18" height="18" x="3" y="3" rx="2" ry="2" />
      <path d="M9 3v18" />
