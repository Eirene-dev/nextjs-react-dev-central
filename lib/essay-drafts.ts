...
// 7일. 태그 무효화가 정확성을 보장하므로 TTL 은 안전망일 뿐이고, 짧을수록 손해다:
// 캐시 키가 잘게 쪼개져 있어(목록 1 + 글별 N + 인접 N) 키마다 만료 시각이 어긋나고,
// 만료 후 첫 요청이 각각 DB 를 깨운다 — 1시간 TTL 은 그 자체로 하루 수십 번의 wake 였다.
const PUBLIC_TTL = 604800
