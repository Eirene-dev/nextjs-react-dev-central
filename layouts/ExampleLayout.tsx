...
import type { Example, Authors } from 'contentlayer/generated'
              ...
              <dl className="space-y-10">
                <div>
                  ...
                  <dd className="text-base font-medium leading-6 text-gray-500 dark:text-gray-400">
                    <span className="flex items-center w-full p-2 pl-4 rounded-md cursor-not-allowed opacity-60">
                      <Link
                        className="flex items-center p-0 rounded-md hover:underline"
                        href="/example"
                      >
                        예제
                      </Link>
                      <ChevronRight size={18} strokeWidth={1} /> {summary}
                    </span>
                  </dd>
                </div>
              </dl>
